...
public class Cliente extends Usuario {
    ...
    public Cliente(int id, String nomeUsuario, String senha, String nomeCompleto, String telefone, String empresa, String cargo, String segmento, String tamanhoEmpresa, String pais, String emailCorporativo) {
        super(id, nomeUsuario, senha);
        this.nomeCompleto = nomeCompleto;
        this.telefone = telefone;
        this.empresa = empresa;
